        ...
        <div class="card card-outline card-primary shadow rounded-0">
            ...
            <div class="card-body rounded-0">
                <div class="container-fluid">
                    ...
                    <br>
                    <fieldset>
                        <legend class="text-navy">Year Conducted:</legend>
                        <div class="pl-4"><large><?= isset($year) ? $year : "----" ?></large></div>
                    </fieldset>
                    <fieldset>
                        <legend class="text-navy">Description:</legend>
                        <div class="pl-4"><large><?= isset($desc) ? html_entity_decode($desc) : "" ?></large></div>
                    </fieldset>
                    <fieldset>
                        <legend class="text-navy">Organization/s Involved:</legend>
                        <div class="pl-4"><large><?= isset($org) ? html_entity_decode($org) : "" ?></large></div>
                    </fieldset>
                    <fieldset>
                        <legend class="text-navy">Project Proposal:</legend>
                        <div class="pl-4">
