            ...
            <div class="container-fluid">
                <form action="" id="archive-form">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label for="title" class="control-label text-navy">Activity Title</label>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label for="year" class="control-label text-navy">Year conducted</label>
                                <select name="year" id="year" class="form-control form-control-border" required>
                                    <?php
                                    for ($i = 0; $i < 51; $i++):
                                        ?>
                                        <option <?= isset($year) && $year == date("Y", strtotime(date("Y") . " -{$i} years")) ? "selected" : "" ?>><?= date("Y", strtotime(date("Y") . " -{$i} years")) ?>
                                        </option>
                                    <?php endfor; ?>
                                </select>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group">
                                <label for="desc" class="control-label text-navy">Description</label>
                                <textarea rows="3" name="desc" id="desc" placeholder="desc"
                                    class="form-control form-control-border summernote"
                                    required><?= isset($desc) ? html_entity_decode($desc) : "" ?></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group">
                                <label for="org" class="control-label text-navy">Organization/s Involved</label>
                                <textarea rows="3" name="org" id="org" placeholder="org"
                                    class="form-control form-control-border summernote-list-only"
                                    required><?= isset($org) ? html_entity_decode($org) : "" ?></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group">
                                <label for="img" class="control-label text-muted">Main Activity Image/Banner
                                    Image</label>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group">
                                <label for="pdf" class="control-label text-muted">Project Proposal (PDF file)</label>
            ...
            $.ajax({
                ...
                success: function (resp) {
                    if (resp.status == 'success') {
                        location.href = "./?page=student-archive/view_archive&id=" + resp.id
                    } else if (!!resp.msg) {
                        el.text(resp.msg)
                        el.addClass("alert-danger")
                        _this.prepend(el)
