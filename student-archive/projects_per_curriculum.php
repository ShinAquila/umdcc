        ...
        <div class="card card-outline card-danger shadow rounded-0">
            <div class="card-body rounded-0">
                ...
                <div class="list-group">
                    ...
                    ?>
                    <a href="./?page=student-archive/view_archive&id=<?= $row['id'] ?>" class="text-decoration-none text-dark list-group-item list-group-item-action">
                        <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <ul class="pagination pagination-sm m-0 float-right">
                                ...
                                <li class="page-item"><a class="bg-danger page-link <?= $page == $i ? 'active' : '' ?>" href="./?page=projects_per_curriculum&id=<?= $id ?>&p=<?= $i ?>"><?= $i ?></a></li>
                                <?php endfor; ?>
