        ...
        <div class="card card-outline card-warning shadow rounded-0">
            ...
            <div class="card-body rounded-0">
                <div class="container-fluid">
                    ...
                    <small class="text-muted">Submitted by <b class="text-danger"><?= $submitted ?></b> on
                    ...
                    <br>
                    <fieldset>
                        <h5 class="text-danger">Year Conducted:</h5>
                        <div class="pl-4">
                    ...
                    <fieldset>
                        ...
                        <div class="pl-4">
                            <large><?= isset($desc) ? html_entity_decode($desc) : "" ?></large>
                        </div>
                    </fieldset>
                    <fieldset>
                        <h5 class="text-danger">Organization/s Involved:</h5>
                        <div class="pl-4">
                            <large><?= isset($org) ? html_entity_decode($org) : "" ?></large>
                        </div>
                    </fieldset>
                    <fieldset>
                        <h5 class="text-danger">Project Proposal:</h5>
                        <div class="pl-4">
